...
public class LoginTests {
	...
	private void setup(String browser) {
		...
		case "firefox":
			System.setProperty("webdriver.gecko.driver","C:/Users/ismai/eclipse-workspace/learningspace/selenium-for-beginners/src/main/resources/geckodriver.exe");
		...
		default:
			System.out.println("Default Chrome browser started");
			System.setProperty("webdriver.chrome.driver","C:/Users/ismai/eclipse-workspace/learningspace/selenium-for-beginners/src/main/resources/chromedriver.exe");
			driver = new ChromeDriver();
			break;
...
//		successfull message
	...
	@Parameters({ "browser","username", "password", "expectedmsg" })
	@Test(priority = 2, groups = { "negativeTests", "smokeTest" })
	public void negativeLoginTest(String browser, String username, String password, String expectedErrormsg) {
